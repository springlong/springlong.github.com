<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsInfo.aspx.cs" Inherits="GlobalTest.NewsInfo" %>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <asp:Localize ID="Localize1" runat="server" meta:ResourceKey="LocalizeContent"></asp:Localize>

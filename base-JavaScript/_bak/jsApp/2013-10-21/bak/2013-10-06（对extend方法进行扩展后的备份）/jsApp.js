    ...
    jsApp.extend(/** @lends jsApp */{
        ...
        browser: (function()
        {
            ...
            if(!document.addEventListener)
            {
                ...
                document.write("<style>* html{background-image:url(about:blank);}header,footer,aside,article,section,hgroup,nav,menu,canvas,details,figure,figcaption,audio,video{display:block;}</style>")
            }

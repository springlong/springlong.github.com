...
if(data_ele)
{
	...
	html += '		<th>';
	html += '			<span>省/市</span>';
	html += '			<span class="a"><a href="javascript:void(0)" target="_self" onclick="area_addAll()">全部添加</a></span>';
	html += '		</th>';
	html += '		<th>';
	html += '			<span>已选地理位置</span>';
	html += '			<span class="a"><a href="javascript:void(0)" target="_self" onclick="area_clearAll()">全部删除</a></span>';
	html += '		</th>';
	html += '	</tr>';
	...
	html += '		<td>';
	html += '			<button id="area_submit">完成</button>';
	html += '			<button id="area_reset" onclick="area_clearAll()">取消</button>';
	html += '		</td>';
	html += '		<td class="save">';
	html += '			<button id="area_save">保存</button>';
	html += '			<button id="area_recover">恢复</button>';
	html += '		</td>';
	html += '	</tr>';
	html += '</table>';
	...
	var data_textBak = "";							//用来保存data_text的字符串备份值	

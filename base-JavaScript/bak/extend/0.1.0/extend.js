/**
 * @file        让老版本的浏览器支持EcmaScript6的部分新特性，以及DOM3的相关方法
...
(function(){
    ...
    function rewriteEvent(e)
    {
        ...
        if(/mouse|click/gi.test(e.type)){
            ...
            e.relatedTarget = "mouseover,mouseenter".indexOf(e.type) >= 0 ? e.fromElement : e.toElement;   
        ...
        //键盘按键事件的兼容性处理
        else if(/key/gi.test(e.type)){

            //键盘按键的键码值
            e.keyCode = e.keyCode === 0 ? e.charCode : e.keyCode;
        }

...
(function(window){
    ...
    jsApp.init = function(selector, context)
    {
        ...
        {
            makeIn.call(_self, jsApp.find(selector, context));
        }
    ...
    jsApp.fn = jsApp.prototype = /** @lends jsApp.prototype */{
        ...
        next: function(selector)
        {
            ...
            return jsApp(jsApp.isString(selector) ? jsApp.matches(selector, result) : result);
        },
        ...
        add: function(selector, context)
        {
            ...
            //将jsApp对象加入
            else if(selector instanceof jsApp)
            {
                result = selector;
            }
            //将DOM元素加入
            ...
            result = jsApp.unique(jsApp.merge(result, this));
    ...
    jsApp.extend(/** @lends jsApp */{
        ...
        merge: function(first, second)
        {
            ...
            first = jsApp.isArrayLike(first) ? first : [];
            j = first.length;

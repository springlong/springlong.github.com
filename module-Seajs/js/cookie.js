 ...
 * @copyriht    https://github.com/springlong/jquery-cookie
 */

console.log('module cookie start');

define("local/cookie", [], function(require, exports, module){
	
	console.log('module cookie code');
